...
rem Channel: Alpha
rem Quantum Kernel 1.0RCT - 12.0.10008.100
rem ==================================================================================
...
CALL Text1 1 1 %THEMEcolor% "%_WbOS% %_version% %_sysbuild% - Q%_quantum-ver%" X _Button_Boxes _Button_Hover
...
CALL Text 184 53 %THEMEcolor% "%_WbOS% %_version%" X _Button_Boxes _Button_Hover
...
:DESKTOP.TASKBAR
CALL Text -2 55 %THEMEcolor% "                                                                                                                                                                                                                  " X _Button_Boxes _Button_Hover
CALL Text -2 56 %THEMEcolor% "                                                                                                                                                                                                                  " X _Button_Boxes _Button_Hover
CALL Text -2 57 %THEMEcolor% "                                                                                                                                                                                                                  " X _Button_Boxes _Button_Hover
CALL Text -2 58 %THEMEcolor% "                                                                                                                                                                                                                  " X _Button_Boxes _Button_Hover





rem call insertphoto 30 785 1000 taskbar.%THEME%.bmp
rem call insertphoto 0 785 1000 taskbar.%THEME%.bmp
...
rem draw time
CALL Text 199 56 %THEMEcolor% " %Time:~0,-6% " 198 57 %THEMEcolor% "%DATE:~-10%" X _Button_Boxes _Button_Hover
exit /b
...
IF %_TASKBAR.ALIGNMENT%==1 (
	...
	IF %_START.EXE%==1 (
		IF %Button%==1 IF %X% GTR 3 IF %Y% GTR 15 IF %X% LSS 13 IF %Y% LSS 20 goto :EDGE.EXE
		IF %Button%==1 IF %X% GTR 19 IF %Y% GTR 15 IF %X% LSS 29 IF %Y% LSS 20 goto :NOTEPAD.EXE
		IF %Button%==1 IF %X% GTR 33 IF %Y% GTR 15 IF %X% LSS 47 IF %Y% LSS 20 goto :EXPLORER.EXE
		IF %Button%==1 IF %X% GTR 50 IF %Y% GTR 15 IF %X% LSS 61 IF %Y% LSS 20 goto :SETTINGS.EXE
		IF %Button%==1 IF %X% GTR 65 IF %Y% GTR 15 IF %X% LSS 76 IF %Y% LSS 20 goto :SECURITY.EXE
		IF %Button%==1 IF %X% GTR 81 IF %Y% GTR 15 IF %X% LSS 92 IF %Y% LSS 20 goto :CALCULATOR.EXE
		
		IF %Button%==2 IF %X% GTR 3 IF %Y% GTR 15 IF %X% LSS 13 IF %Y% LSS 20 goto :START.RIGHTCLICKAPP
		IF %Button%==2 IF %X% GTR 19 IF %Y% GTR 15 IF %X% LSS 29 IF %Y% LSS 20 goto :START.RIGHTCLICKAPP
		IF %Button%==2 IF %X% GTR 33 IF %Y% GTR 15 IF %X% LSS 47 IF %Y% LSS 20 goto :START.RIGHTCLICKAPP
		IF %Button%==2 IF %X% GTR 50 IF %Y% GTR 15 IF %X% LSS 61 IF %Y% LSS 20 goto :START.RIGHTCLICKAPP
		IF %Button%==2 IF %X% GTR 65 IF %Y% GTR 15 IF %X% LSS 76 IF %Y% LSS 20 goto :START.RIGHTCLICKAPP
		IF %Button%==2 IF %X% GTR 81 IF %Y% GTR 15 IF %X% LSS 92 IF %Y% LSS 20 goto :START.RIGHTCLICKAPP

		IF %Button%==1 IF %X% GTR 3 IF %Y% GTR 21 IF %X% LSS 13 IF %Y% LSS 26 goto :TERMINAL.EXE
		IF %Button%==1 IF %X% GTR 19 IF %Y% GTR 21 IF %X% LSS 29 IF %Y% LSS 26 goto :PHOTOS.EXE
		IF %Button%==1 IF %X% GTR 33 IF %Y% GTR 21 IF %X% LSS 47 IF %Y% LSS 26 goto :PAINT.EXE
		IF %Button%==1 IF %X% GTR 50 IF %Y% GTR 21 IF %X% LSS 61 IF %Y% LSS 26 goto :CALENDAR.EXE
		IF %Button%==1 IF %X% GTR 65 IF %Y% GTR 21 IF %X% LSS 76 IF %Y% LSS 26 goto :WINDOWEDTEST.APP
		IF %Button%==1 IF %X% GTR 81 IF %Y% GTR 21 IF %X% LSS 92 IF %Y% LSS 26 goto :TASKMGR.EXE

		IF %Button%==2 IF %X% GTR 3 IF %Y% GTR 21 IF %X% LSS 13 IF %Y% LSS 26 goto :START.RIGHTCLICKAPP
		IF %Button%==2 IF %X% GTR 19 IF %Y% GTR 21 IF %X% LSS 29 IF %Y% LSS 26 goto :START.RIGHTCLICKAPP
		IF %Button%==2 IF %X% GTR 33 IF %Y% GTR 21 IF %X% LSS 47 IF %Y% LSS 26 goto :START.RIGHTCLICKAPP
		IF %Button%==2 IF %X% GTR 50 IF %Y% GTR 21 IF %X% LSS 61 IF %Y% LSS 26 goto :START.RIGHTCLICKAPP
		IF %Button%==2 IF %X% GTR 65 IF %Y% GTR 21 IF %X% LSS 76 IF %Y% LSS 26 goto :START.RIGHTCLICKAPP
		IF %Button%==2 IF %X% GTR 81 IF %Y% GTR 21 IF %X% LSS 92 IF %Y% LSS 26 goto :START.RIGHTCLICKAPP

		rem Power
		IF %Button%==1 IF %X% GTR 84 IF %Y% GTR 51 IF %X% LSS 89 IF %Y% LSS 53 goto :START.POWER
	)

	rem Power
		IF %_START.EXE%==1 IF %Button%==1 IF %X% GTR 84 IF %Y% GTR 51 IF %X% LSS 89 IF %Y% LSS 53 goto :START.POWER
...
CALL Text1 92 26 %THEMEcolor% "        Shut down        " 92 30 %THEMEcolor% "         Restart         " 92 34 %THEMEcolor% "        Hibernate        " 92 38 %THEMEcolor% "        Sign  Out        " 92 42 %THEMEcolor% "          Cancel         " X _Button_Boxes _Button_Hover
...
call insertphoto 1350 9 100 WindowedButtons.%THEME%.bmp
CALL Text 8 0 %THEMEcolor% "Settings" X _Button_Boxes _Button_Hover
...
rem magic number: 43
PIXELDRAW /dr 450 150 /rd 800 40 /c 7
CALL Text 65 10 %blueTHEMEcolor% "Notifications" X _Button_Boxes _Button_Hover
CALL Text 65 11 %blueTHEMEcolor% "Updates from external apps on winbatchOS" X _Button_Boxes _Button_Hover
CALL Text 170 11 %THEMEcolor% "Yes" X _Button_Boxes _Button_Hover


PIXELDRAW /dr 450 205 /rd 800 40 /c 7
CALL Text 65 14 %blueTHEMEcolor% "Do Not Disturb" X _Button_Boxes _Button_Hover
CALL Text 65 15 %blueTHEMEcolor% "Notifications will go to the notification center" X _Button_Boxes _Button_Hover
CALL Text 161 15 %lightTHEMEcolor% "Not available" X _Button_Boxes _Button_Hover


PIXELDRAW /dr 450 255 /rd 800 320 /c 7
CALL Text 65 18 %blueTHEMEcolor% "Notifications from apps or scripts" X _Button_Boxes _Button_Hover
CALL Text 65 19 %THEMEcolor% "Based on all current or past app senders" X _Button_Boxes _Button_Hover

CALL Text 160 19 %THEMEcolor% "Not available" X _Button_Boxes _Button_Hover
...
CALL Text 65 30 %blueTHEMEcolor% "Color" X _Button_Boxes _Button_Hover
CALL Text 65 31 %blueTHEMEcolor% "Accent color, transparency effects, light/dark theme" X _Button_Boxes _Button_Hover

PIXELDRAW /dr 400 471 /rd 800 40 /c 7
CALL Text 65 33 %blueTHEMEcolor% "Themes" X _Button_Boxes _Button_Hover
CALL Text 65 34 %blueTHEMEcolor% "Create, manage" X _Button_Boxes _Button_Hover

PIXELDRAW /dr 400 514 /rd 800 40 /c 7
CALL Text 65 36 %blueTHEMEcolor% "Lock screen" X _Button_Boxes _Button_Hover
CALL Text 65 37 %blueTHEMEcolor% "Default image, app Notifications" X _Button_Boxes _Button_Hover
...
CALL Text 65 45 %blueTHEMEcolor% "Taskbar" X _Button_Boxes _Button_Hover
CALL Text 65 46 %blueTHEMEcolor% "Taskbar alignment, hide/show taskbar" X _Button_Boxes _Button_Hover
...
CALL Text 65 24 %lightTHEMEcolor% "Toggle the button on the right." X _Button_Boxes _Button_Hover
...
CALL Text 70 10 %lightTHEMEcolor% "Version 2212" X _Button_Boxes _Button_Hover
...
CALL Text 65 23 %blueTHEMEcolor% "Advanced Options" X _Button_Boxes _Button_Hover
CALL Text 65 24 %blueTHEMEcolor% "Optional Updates, System Servers" X _Button_Boxes _Button_Hover

PIXELDRAW /dr 400 379 /rd 800 40 /c 7

CALL Text 65 26 %blueTHEMEcolor% "winbatchOS Preview Builds" X _Button_Boxes _Button_Hover
CALL Text 65 27 %blueTHEMEcolor% "Download and preview beta builds of winbatchOS" X _Button_Boxes _Button_Hover
...
CALL Text 60 43 %THEMEcolor% "Notice:" X _Button_Boxes _Button_Hover
CALL Text 65 45 %THEMEcolor% "%_WBXCore-updatealert%" X _Button_Boxes _Button_Hover
goto :KERNEL.EXE
...
CALL Text 44 10 %THEMEcolor% "File Explorer is not updated for winbatchOS 18. Upgrade to winbatchOS 18.1 for a updated file explorer and other released apps." X _Button_Boxes _Button_Hover
rem CALL Text 44 10 %THEMEcolor% "Quick Access" X _Button_Boxes _Button_Hover

 rem Call insertphoto 320 180 100 explorer.desktop.folder.bmp
 rem CALL Text 45 16 %THEMEcolor% "Desktop" X _Button_Boxes _Button_Hover

 rem Call insertphoto 420 180 100 explorer.documents.folder.bmp
 rem CALL Text 59 16 %THEMEcolor% "Documents" X _Button_Boxes _Button_Hover

 rem Call insertphoto 520 180 100 explorer.downloads.folder.bmp
 rem CALL Text 73 16 %THEMEcolor% "Downloads" X _Button_Boxes _Button_Hover

 rem Call insertphoto 620 180 100 explorer.music.folder.bmp
 rem CALL Text 89 16 %THEMEcolor% "Music" X _Button_Boxes _Button_Hover

 rem Call insertphoto 720 180 100 explorer.pictures.folder.bmp
 rem CALL Text 102 16 %THEMEcolor% "Pictures" X _Button_Boxes _Button_Hover

 rem Call insertphoto 820 180 100 explorer.videos.folder.bmp
 rem CALL Text 117 16 %THEMEcolor% "Videos" X _Button_Boxes _Button_Hover
...
CALL Text 15 7 %THEMEcolor% "To show a photo, click on the top-right button named 'Import'. " X _Button_Boxes _Button_Hover
