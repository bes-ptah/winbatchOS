...
rem  | Quantum Kernel Version        | 1.0RC1            |
rem  | NI Kernel Version             | 11.0prerelease1   |
...
CALL Text 183 54 %THEMEcolor% "%_build% - Q%_quantum-ver%" X _Button_Boxes _Button_Hover
exit /b 
...
IF %_TASKBAR.ALIGNMENT%==1 (
	...
	rem Close the Start Menu - ButtonOnly:
