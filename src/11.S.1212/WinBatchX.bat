...
echo ON to-do list coming in Build 1518. SECURITY BUILD

echo EXPECTED
echo BUILD 1504 - Release of January 2021 Update Builds - Build 1504
echo BUILD 1506 - NEW UI FEATURES + UPGRADE APPS
echo BUILD 1508 - NOTEPAD v1.5.8 RELEASE
echo BUILD 1510 - CREATE A BOOTSECTOR - somehow
echo BUILD 1510 - CREATE FAST BOOT ALWAYS, not SOMETIMES
echo BUILD 1512 - DESK UPDATE
echo BUILD 1513 BETA - fix bugs round #2
echo BUILD 1514 - SEARCH BAR FOR MENU - IF POSSIBLE
echo BUILD 1516 - UPDATE & CREATE A UPDATE + UPGRADE MANAGER
echo BUILD 1518 - SECURITY UPDATE - RELEASE OF FEBUARY 2021 UPDATE BUILD
