...
CALL Text 70 20 %THEMEcolor% "Try upgrading WinBatchX to 18.1 for a automatic setup experience." X _Button_Boxes _Button_Hover

CALL Text 70 25 %THEMEcolor% "Click and hold anywhere to continue back to WinBatchX 18." X _Button_Boxes _Button_Hover
