...
IF %_build%==1747 set update.exe=0x00 &set update-status-action.exe=0x00 &set update-newer-release-message="You are on the latest build." &call news.bat &del news.bat &del upgrade.bat &exit /b
