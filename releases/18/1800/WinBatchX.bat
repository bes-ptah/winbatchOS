...
rem Build Previews
rem	CALL ButtonHeight0 197 53 %THEMEcolor% "WinBatchX %_version%" X _Button_Boxes _Button_Hover
rem CALL ButtonHeight0 199 54 %THEMEcolor% "Build %_build%" X _Button_Boxes _Button_Hover
...
rem  moved the draw time to the desktop to fasten the kernel
CALL ButtonHeight0 201 56 %THEMEcolor% "%_WBX-TASKBAR-TIME%" 199 57 %THEMEcolor% "%_WBX-TASKBAR-DATE%" X _Button_Boxes _Button_Hover
...
rem [%%A] [%%B] [%%C] [%%D]
	...
	CALL ButtonHeight0 201 56 %THEMEcolor% "%_WBX-TASKBAR-TIME%" X _Button_Boxes _Button_Hover
	rem GUI SYSTEM!
	rem READ FIRST
	rem .
	...
	rem Desktop Icons
	IF %_ACTIVEAPPLABEL%==explorer.exe IF %I%==m IF %M% EQU 1 IF %X% GTR 1 IF %Y% GTR 8 IF %X% LSS 24 IF %Y% LSS 15 goto :EDGE.EXE
...
Call Button 176 35 f0 "January %DATE:~-7,2%" X _Button_Boxes _Button_Hover
...
Call Button 176 35 f0 "Febuary %DATE:~-7,2%" X _Button_Boxes _Button_Hover
...
Call Button 176 35 f0 "March %DATE:~-7,2%" X _Button_Boxes _Button_Hover
...
Call Button 176 35 f0 "April %DATE:~-7,2%" X _Button_Boxes _Button_Hover
...
Call Button 176 35 f0 "May %DATE:~-7,2%" X _Button_Boxes _Button_Hover
...
Call Button 176 35 f0 "June %DATE:~-7,2%" X _Button_Boxes _Button_Hover
...
Call Button 176 35 f0 "July %DATE:~-7,2%" X _Button_Boxes _Button_Hover
...
Call Button 176 35 f0 "August %DATE:~-7,2%" X _Button_Boxes _Button_Hover
...
Call Button 176 35 f0 "September %DATE:~-7,2%" X _Button_Boxes _Button_Hover
...
Call Button 176 35 f0 "October %DATE:~-7,2%" X _Button_Boxes _Button_Hover
...
Call Button 176 35 f0 "November %DATE:~-7,2%" X _Button_Boxes _Button_Hover
...
Call Button 176 35 f0 "December %DATE:~-7,2%" X _Button_Boxes _Button_Hover
...
rem Call Button %Xright% %Yright1% f0 "                       " X _Button_Boxes _Button_Hover
rem Call Button %Xright% %Yright2% f0 "                       " X _Button_Boxes _Button_Hover
rem Call Button %Xright% %Yright3% f0 "                       " X _Button_Boxes _Button_Hover
rem Call Button %Xright% %Yright4% f0 "                       " X _Button_Boxes _Button_Hover
rem Call Button %Xright% %Yright5% f0 "                       " X _Button_Boxes _Button_Hover
rem Call Button %Xright% %Yright6% f0 "                       " X _Button_Boxes _Button_Hover
rem Call Button %Xright% %Yright7% f0 "                       " X _Button_Boxes _Button_Hover
rem Call Button %Xright% %Yright8% f0 "                       " X _Button_Boxes _Button_Hover
