...
The latest **stable** build is currently **1605**.
...
###### Note: WinBatchX's latest updates has moved to the wiki page.

###### Note: WinBatchX's Support Page has moved to the wiki page. 
